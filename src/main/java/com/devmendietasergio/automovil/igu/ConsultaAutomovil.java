...
public class ConsultaAutomovil extends javax.swing.JFrame {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (tablaAutos.getRowCount() > 0) {
            ...
            if (tablaAutos.getSelectedRow() != -1) {//si da menos -1, es porque no se selecciono nada.
                //obtener id autos que quiero borrar
            ...
            mostrarMensaje("La tabla esta vacia, nos e puede eliminar", "Error", "Error al eliminar");
        }
    ...
    private void cargarTabla() {
        ...
        DefaultTableModel modeloTabla = new DefaultTableModel() {
            @Override //se agrega porque iscelleditable ya existe, con override sobreescribe
            public boolean isCellEditable(int row, int colimn) {
                return false;
            }
        };
        //ponemos titulos a las columnas
        String titulos[] = {"Id", "Modelo", "Marca", "Motor", "Color", "Patente", "Puertas"};//creamos array con titulos
        ...
        if (listaAutomoviles != null) {
            for (Automovil auto : listaAutomoviles) {
                Object[] objecto = {auto.getId(), auto.getModelo(), auto.getMarca(), auto.getMotor(), auto.getColor(), auto.getPatente(), auto.getCantPuertas()};
                modeloTabla.addRow(objecto);

            }
        }

        tablaAutos.setModel(modeloTabla);//a la tabla agrego el modelotabla
